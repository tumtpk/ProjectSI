...
class GoalStudentsAdvisoryGraph extends Component { 
...
componentWillMount() {
    CommonApi.instance.get('/goal/graphByCommanderStudent/'+ this.state.semester +","+ this.state.year)
    .then(response => {
...
render() {
  ...
  export default GoalStudentsAdvisoryGraph;