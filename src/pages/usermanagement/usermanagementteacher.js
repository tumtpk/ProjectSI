...
class Usermanagement1 extends Component { 
      ...
      return _.map(this.state.teacherList, teacherList => {
        ...
        return (
          <tr>
            ...
            <td>{ teacherList.titleName}{ teacherList.firstname }</td>
            <td>{ teacherList.lastname }</td>
            <td>{ teacherList.email }</td>
            <td>{ (teacherList.status == 1) ? "เปิดใช้งาน" : "ปิดใช้งาน" }</td>
            <td>
              <Link to={ {pathname: `/usermanagement/viewteacher`, query: {userID: teacherList.userID}} }><button className="btn btn-success btn-xs" data-toggle="ดูรายละเอียด" data-placement="bottom" title="ดูรายละเอียด"><i className="fa fa-eye"></i></button></Link>
              <Link to={ {pathname: `/usermanagement/updateteacher`, query: {userID: teacherList.userID}} }><button className="btn btn-primary btn-xs" data-toggle="แก้ไข" data-placement="bottom" title="แก้ไข"><i className="fa fa-edit"></i></button></Link>
              <button className="btn btn-danger btn-xs" data-toggle="ลบ" data-placement="bottom" title="ลบ"><i className="fa fa-trash-o " data-toggle="modal" data-target={"#"+teacherList.userID}></i></button>
      ...
      return (
        <div className="row mt">
              ...
              <Link to={ {pathname: `/usermanagementstudent`} }><button type="button" className="btn btn-default btn-lg btn-block" > นักศึกษา</button></Link>
						  ...
						  <div className="btn-group">
              <Link to={ {pathname: `/usermanagementteacher`} }><button type="button" className="btn btn-warning btn-lg btn-block"> อาจารย์</button></Link>
						  </div>
						  <div className="btn-group">
              ...
              <div className="btn-group">
						  <Link to={ {pathname: '/usermanagementadmin'}}><button type="button" className="btn btn-default btn-lg btn-block"> ผู้ดูแลระบบ</button></Link>
						  </div>
						</div> 
        ...
        <section id="main-content">
          <section className="wrapper">
            ...
            <div className="row"> 
                ...
                <Link to={ {pathname: `/usermanagement/createteacher`} }><button type="button" className="btn btn-primary" >เพิ่มผู้ใช้งาน</button></Link>
                </div>
            </div>
