      ...
      return _.map(this.state.studentList, studentList=> {
        ...
        return (
          <tr>
            ...
            <td>
              <Link to={ {pathname: `/usermanagement/viewstudent`, query: {userID: studentList.userID}} }><button className="btn btn-success btn-xs" data-toggle="ดูรายละเอียด" data-placement="bottom" title="ดูรายละเอียด"><i className="fa fa-eye"></i></button></Link>
              <Link to={ {pathname: `/usermanagement/updatestudent`, query: {userID: studentList.userID}} }><button className="btn btn-primary btn-xs" data-toggle="แก้ไข" data-placement="bottom" title="แก้ไข"><i className="fa fa-edit"></i></button></Link>
    ...
    renderFromSearchStudent(){
      ...
      return (
        <div className="row mt">
              ...
              <Link to={ {pathname: `/usermanagementstudent`} }><button type="button" className="btn btn-warning btn-lg btn-block" > นักศึกษา</button></Link>
						  </div>
						  <div className="btn-group">
          ...
          <section className="wrapper">
            <div className="row"> 
                ...
                <div className="col-md-4 text-right" style={{marginTop: '15px'}}>
                  <Link to={ {pathname: `/usermanagement/createstudent`} }><button type="button" className="btn btn-primary" >เพิ่มผู้ใช้งาน</button></Link>
                </div>
            </div>
