...
class UserUpdateStudent extends Component { 
    ...
    constructor(props) {
      ...
      handleSubmit(event) {
        ...
        console.log(this.state);
                ...
                CommonApi.instance.post('/user/isDuplicateEmailUpdate' ,this.state)
                .then(response =>{
    ...
    render() {
      ...
      if (redirect) {
        return <Redirect to='/usermanagementstudent'/>;
      }
                ...
                <div className="form-panel">
                    ...
                    <h4 className="mb"><i className="fa fa-angle-right"></i> กรอกข้อมูลผู้ใช้งาน</h4>
                        ...
                        <div className="text-right">
                            ...
                            <Link to={ {pathname: `/usermanagementstudent`} }><button type="button" className="btn btn-danger">ยกเลิก</button></Link>
                        </div>
                    </form>
                </div>
              </div>
  ...
  export default UserUpdateStudent;