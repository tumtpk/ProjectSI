...
class UserUpdateHead extends Component { 
    ...
    render() {
      ...
      if (redirect) {
        return <Redirect to='/usermanagementhead'/>;
      }
                ...
                <div className="form-panel">
                     <div className="alert alert-danger alert-dismissable" hidden={this.state.duplicate}>
                        ...
                        <div className="text-right">
                            ...
                            <Link to={ {pathname: `/usermanagementhead`} }><button type="button" className="btn btn-danger">ยกเลิก</button></Link>
                        </div>
                    </form>
                </div>
              </div>
