          ...
          <section className="wrapper">
            <div className="row"> 
                ...
                <div className="col-md-4 text-right" style={{marginTop: '15px'}}>
                    <a href="create"><button type="button" className="btn btn-primary" >เพิ่มผู้ใช้งาน</button></a>
                </div>
            </div>
                      ...
                      <form className="form-horizontal style-form" onSubmit={this.handleSubmit}>
                          <div className="form-group">
                            ...
                            <div className="text-center">
                              ...
                              <button type="button" className="btn btn-round btn-danger">ยกเลิก</button>
                            </div>                                                                                     
                      </form>
                            ...
                            <thead>
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>นักศึกษา</td>
                                  <td>
                                      <a href="detail"><button className="btn btn-success btn-xs"><i className="fa fa-eye"></i></button></a>
                                      <a href="update"><button className="btn btn-primary btn-xs"><i className="fa fa-edit"></i></button></a>
