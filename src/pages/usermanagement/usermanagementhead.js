      ...
      return _.map(this.state.headList, headList => {
        ...
        return (
          <tr>
            ...
            <td>{ headList.titleName}{ headList.firstname }</td>
            <td>{ headList.lastname }</td>
            <td>{ headList.email }</td>
            <td>{ (headList.status == 1) ? "เปิดใช้งาน" : "ปิดใช้งาน" }</td>
            <td>
              <Link to={ {pathname: `/usermanagement/viewhead`, query: {userID: headList.userID}} }><button className="btn btn-success btn-xs" data-toggle="ดูรายละเอียด" data-placement="bottom" title="ดูรายละเอียด"><i className="fa fa-eye"></i></button></Link>
              <Link to={ {pathname: `/usermanagement/updatehead`, query: {userID: headList.userID}} }><button className="btn btn-primary btn-xs" data-toggle="แก้ไข" data-placement="bottom" title="แก้ไข"><i className="fa fa-edit"></i></button></Link>
              <button className="btn btn-danger btn-xs" data-toggle="ลบ" data-placement="bottom" title="ลบ"><i className="fa fa-trash-o " data-toggle="modal" data-target={"#"+headList.userID}></i></button>
      ...
      return (
        <div className="row mt">
              ...
              <Link to={ {pathname: `/usermanagementteacher`} }><button type="button" className="btn btn-default btn-lg btn-block"> อาจารย์</button></Link>
						  ...
						  <div className="btn-group">
						  <Link to={ {pathname: '/usermanagementhead'}}><button type="button" className="btn btn-warning btn-lg btn-block"> ประธานหลักสูตร</button></Link>
						  </div>
              <div className="btn-group">
        ...
        <section id="main-content">
          <section className="wrapper">
            ...
            <div className="row"> 
                ...
                <Link to={ {pathname: `/usermanagement/createhead`} }><button type="button" className="btn btn-primary" >เพิ่มผู้ใช้งาน</button></Link>
                </div>
            </div>
